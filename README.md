...
stager/js/tcp | osx/entypreter/reverse_tcp | Serves macOS reverse TCP (not available here, available at Mouse Payload Loader (MPL) https://github.com/entynetproject/mouse).
